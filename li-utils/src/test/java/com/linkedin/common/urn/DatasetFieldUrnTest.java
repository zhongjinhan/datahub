...
public class DatasetFieldUrnTest {
  ...
  private static final String LAYER = "fooLayer";
  ...
  public void testSerialization() throws URISyntaxException {
    ...
    Assertions.assertThat(datasetUrn.getLayerEntity()).isEqualTo(LAYER);
  ...
  public void testCreateUrn() {
    ...
    final DatasetFieldUrn datasetFieldUrn = new DatasetFieldUrn(PLATFORM, DATASET_NAME, LAYER, FIELD_NAME);
  ...
  public void testUrnConstructors() {
    final DatasetFieldUrn datasetFieldUrn1 = new DatasetFieldUrn(PLATFORM, DATASET_NAME, LAYER, FIELD_NAME);
